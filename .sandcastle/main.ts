...
await run({
  ...
  // The agent provider. Sonnet balances capability and speed for most tasks.
  // Switch to claude-opus-4-6 for harder problems.
  ...
  hooks: {
    sandbox: {
      ...
      onSandboxReady: [{ command: "corepack enable && pnpm install --frozen-lockfile" }],
    },
  },
});
