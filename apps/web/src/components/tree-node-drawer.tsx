  ...
  return (
    ...
    >
      {result.snapshot.image ? (
        ...
        <div className="flex size-14 shrink-0 items-center justify-center rounded-md border border-border/60 bg-muted/35 text-[0.65rem] text-muted-foreground uppercase">
      ...
      <div className="min-w-0 flex-1">
        <div className="flex flex-wrap items-start justify-between gap-2">
          <div className="min-w-0">
            <p className="truncate font-mono text-sm text-foreground">{result.snapshot.name}</p>
            <div className="mt-1 flex flex-wrap items-center gap-2 font-mono text-[0.6rem] tracking-wide text-muted-foreground uppercase">
        ...
        >
          ...
          <div className="flex-1 space-y-5 overflow-y-auto px-6 py-5">
            <div className="rounded-2xl border border-border/70 bg-muted/35 px-4 py-3">
              ...
              <p className="mt-1 text-sm text-foreground">{parentLabel}</p>
            </div>
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <Input
                    ...
                    placeholder="Start typing a title, person, album, film..."
              ...
              <div className="space-y-3">
                ...
                {deferredQuery.length >= 2 && !showSearching ? (
                  <button
                    ...
                    className={cn(
                      "flex w-full items-center justify-between rounded-lg border border-dashed px-3 py-2.5 text-left transition-colors",
                      creatingConcept
              ...
              <div className="rounded-2xl border border-border/70 bg-card/60 p-4">
                <div className="flex items-start justify-between gap-3">
                  <div className="min-w-0">
                    ...
                    <p className="mt-1 font-mono text-base text-foreground">{trimmedQuery}</p>
                  </div>
                  <Button
                    type="button"
                    variant="ghost"
                ...
                <div className="mt-4 space-y-2">
                  ...
                  >
                    ...
                    <ListboxOptions
                      ...
                      modal={false}
                      className={cn(
                        "absolute top-full right-0 left-0 z-[70] mt-1 overflow-hidden rounded-2xl border border-border/70 bg-popover p-1 text-popover-foreground shadow-2xl outline-none",
                      )}
                    >
                      {CONCEPT_TYPE_OPTIONS.map((option) => (
                        <ListboxOption
                          ...
                          className={({ focus, selected }) =>
                            cn(
                              "flex w-full cursor-default items-center justify-between rounded-xl px-3 py-2 text-left text-sm transition-colors outline-none",
            ...
            {selectedResult != null || creatingConcept ? (
              <>
                <div className="space-y-2">
                  <Label htmlFor={reasonId}>{selectedResult ? "Note" : "Reason"}</Label>
                  <Textarea
                    id={reasonId}
                    ref={reasonRef}
                    value={reason}
